...
MAP = {
    ...
    'zones': [
        {
            'vertices': [
                (-118.59, 34.02), (-118.55, 34.00), (-118.50, 34.02),
                (-118.47, 34.05), (-118.47, 34.08), (-118.50, 34.10),
                (-118.56, 34.10), (-118.60, 34.07), (-118.59, 34.02),
            ],
    ...
    'scatter_marks': [
        {
            'bounds': (-118.58, -118.48, 34.01, 34.09),
    ...
    'markers': [
        ...
        {
            'lon': -118.49, 'lat': 34.01, 'shape': 'o', 'size': 5,
            'color': '#666666', 'name': 'Santa Monica', 'name_color': '#555555',
            'name_size': 5, 'name_offset': (0.0, -0.02),
        },
        {
